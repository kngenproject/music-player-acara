...
function draw() {
  ...
  // ── VU Meter (simulasi stereo dari mono FFT) ──
  ...
  for (let i = 0; i < barCount; i++) {
    ...
    // height dengan log scale untuk tampilan lebih natural
    ...
    const hue = 45 + (i / barCount) * (-30) // gold ke hijau
    ...
    // reflection (mirror di bawah, transparan)
