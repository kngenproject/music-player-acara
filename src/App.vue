      ...
      <div class="main-layout portrait-layout">
          <div class="app-header">
            ...
            <div class="header-actions">
              ...
              <button class="hdr-icon-btn" :class="{ 'settings-active': wakeLockActive }" @click="showSettings = true" title="Pengaturan"><!-- tablet: show both panels side by side -->
          ...
          <!-- Portrait tab area: on tablet both panes show side by side via CSS grid -->
          <div class="portrait-tab-area">
            <!-- Tab: Now Playing -->
            <div class="tab-pane tab-pane--playing" :class="{ 'tab-active': activeTab === 'playing' }">
              <AudioVisualizer
            ...
            <!-- Tab: Playlist -->
            <div class="tab-pane tab-pane--playlist" :class="{ 'tab-active': activeTab === 'playlist' }">
...
/* .tab-pane is defined below in the portrait-tab-area section */
...
/* ══ PORTRAIT TAB AREA (mobile default: show only active tab) ══ */
.portrait-tab-area {
  flex: 1;
  display: flex;
  flex-direction: column;
...
/* ══ TABLET PORTRAIT: sembunyikan tab, tampilkan split 2 kolom ══ */
...
/* ══ TABLET PORTRAIT medium (600-767px): ukuran UI lebih besar tapi tetap 1 kolom ══ */
